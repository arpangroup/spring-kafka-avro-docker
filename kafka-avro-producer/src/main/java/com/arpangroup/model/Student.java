...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2950990839949277691L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Student\",\"namespace\":\"com.arpangroup.model\",\"fields\":[{\"name\":\"studentName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"studentId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"age\",\"type\":\"int\"}]}");
   ...
   */
  public Student(java.lang.String studentName, java.lang.String studentId, java.lang.Integer age) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: studentId = value$ != null ? value$.toString() : null; break;
   ...
   */
  public static com.arpangroup.model.Student.Builder newBuilder() {
    return new com.arpangroup.model.Student.Builder();
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.arpangroup.model.Student.Builder newBuilder(com.arpangroup.model.Student.Builder other) {
    if (other == null) {
      return new com.arpangroup.model.Student.Builder();
    } else {
      return new com.arpangroup.model.Student.Builder(other);
    }
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.arpangroup.model.Student.Builder newBuilder(com.arpangroup.model.Student other) {
    if (other == null) {
      return new com.arpangroup.model.Student.Builder();
    } else {
      return new com.arpangroup.model.Student.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.arpangroup.model.Student.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.arpangroup.model.Student other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.studentName)) {
        this.studentName = data().deepCopy(fields()[0].schema(), other.studentName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arpangroup.model.Student.Builder setStudentName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arpangroup.model.Student.Builder clearStudentName() {
      studentName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arpangroup.model.Student.Builder setStudentId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arpangroup.model.Student.Builder clearStudentId() {
      studentId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arpangroup.model.Student.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arpangroup.model.Student.Builder clearAge() {
    ...
    public Student build() {
      try {
        ...
        record.studentId = fieldSetFlags()[1] ? this.studentId : (java.lang.String) defaultValue(fields()[1]);
