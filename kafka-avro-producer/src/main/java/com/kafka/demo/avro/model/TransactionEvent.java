...
public class TransactionEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.kafka.demo.avro.model.TransactionEventHeader header;
  /** body of transaction event */
  private com.kafka.demo.avro.model.TransactionEventBody body;
   ...
   */
  public TransactionEvent(com.kafka.demo.avro.model.TransactionEventHeader header, com.kafka.demo.avro.model.TransactionEventBody body) {
    this.header = header;
    this.body = body;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: header = (com.kafka.demo.avro.model.TransactionEventHeader)value$; break;
    case 1: body = (com.kafka.demo.avro.model.TransactionEventBody)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.kafka.demo.avro.model.TransactionEventHeader getHeader() {
    return header;
  }
   ...
   */
  public void setHeader(com.kafka.demo.avro.model.TransactionEventHeader value) {
    this.header = value;
  }
   ...
   */
  public com.kafka.demo.avro.model.TransactionEventBody getBody() {
    return body;
  }
   ...
   * @param value the value to set.
   */
  public void setBody(com.kafka.demo.avro.model.TransactionEventBody value) {
    this.body = value;
  }
   ...
   */
  public static com.kafka.demo.avro.model.TransactionEvent.Builder newBuilder() {
    return new com.kafka.demo.avro.model.TransactionEvent.Builder();
  }
   ...
   * @return A new TransactionEvent RecordBuilder
   */
  public static com.kafka.demo.avro.model.TransactionEvent.Builder newBuilder(com.kafka.demo.avro.model.TransactionEvent.Builder other) {
    if (other == null) {
      return new com.kafka.demo.avro.model.TransactionEvent.Builder();
    } else {
      return new com.kafka.demo.avro.model.TransactionEvent.Builder(other);
    }
  }
   ...
   * @return A new TransactionEvent RecordBuilder
   */
  public static com.kafka.demo.avro.model.TransactionEvent.Builder newBuilder(com.kafka.demo.avro.model.TransactionEvent other) {
    if (other == null) {
      return new com.kafka.demo.avro.model.TransactionEvent.Builder();
    } else {
      return new com.kafka.demo.avro.model.TransactionEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TransactionEvent>
    ...
    private com.kafka.demo.avro.model.TransactionEventHeader header;
    private com.kafka.demo.avro.model.TransactionEventHeader.Builder headerBuilder;
    /** body of transaction event */
    private com.kafka.demo.avro.model.TransactionEventBody body;
    private com.kafka.demo.avro.model.TransactionEventBody.Builder bodyBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kafka.demo.avro.model.TransactionEvent.Builder other) {
      super(other);
      ...
      if (other.hasHeaderBuilder()) {
        this.headerBuilder = com.kafka.demo.avro.model.TransactionEventHeader.newBuilder(other.getHeaderBuilder());
      }
      ...
      if (other.hasBodyBuilder()) {
        this.bodyBuilder = com.kafka.demo.avro.model.TransactionEventBody.newBuilder(other.getBodyBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kafka.demo.avro.model.TransactionEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.header)) {
        this.header = data().deepCopy(fields()[0].schema(), other.header);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.demo.avro.model.TransactionEvent.Builder setHeader(com.kafka.demo.avro.model.TransactionEventHeader value) {
     ...
     * @return This builder.
     */
    public com.kafka.demo.avro.model.TransactionEventHeader.Builder getHeaderBuilder() {
      if (headerBuilder == null) {
        if (hasHeader()) {
          setHeaderBuilder(com.kafka.demo.avro.model.TransactionEventHeader.newBuilder(header));
        } else {
          setHeaderBuilder(com.kafka.demo.avro.model.TransactionEventHeader.newBuilder());
        }
      }
    ...
    public com.kafka.demo.avro.model.TransactionEvent.Builder setHeaderBuilder(com.kafka.demo.avro.model.TransactionEventHeader.Builder value) {
      clearHeader();
      headerBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.demo.avro.model.TransactionEvent.Builder clearHeader() {
      header = null;
      headerBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.demo.avro.model.TransactionEvent.Builder setBody(com.kafka.demo.avro.model.TransactionEventBody value) {
     ...
     * @return This builder.
     */
    public com.kafka.demo.avro.model.TransactionEventBody.Builder getBodyBuilder() {
      if (bodyBuilder == null) {
        if (hasBody()) {
          setBodyBuilder(com.kafka.demo.avro.model.TransactionEventBody.newBuilder(body));
        } else {
          setBodyBuilder(com.kafka.demo.avro.model.TransactionEventBody.newBuilder());
        }
      }
      return bodyBuilder;
    }
    ...
    public com.kafka.demo.avro.model.TransactionEvent.Builder setBodyBuilder(com.kafka.demo.avro.model.TransactionEventBody.Builder value) {
      clearBody();
      bodyBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.demo.avro.model.TransactionEvent.Builder clearBody() {
      body = null;
      bodyBuilder = null;
    ...
    public TransactionEvent build() {
      try {
        ...
        if (headerBuilder != null) {
          ...
          record.header = fieldSetFlags()[0] ? this.header : (com.kafka.demo.avro.model.TransactionEventHeader) defaultValue(fields()[0]);
        }
        if (bodyBuilder != null) {
          try {
          ...
          record.body = fieldSetFlags()[1] ? this.body : (com.kafka.demo.avro.model.TransactionEventBody) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.header == null) {
          this.header = new com.kafka.demo.avro.model.TransactionEventHeader();
        }
        this.header.customDecode(in);
      }

      if (this.body == null) {
        this.body = new com.kafka.demo.avro.model.TransactionEventBody();
      }
