...
public class TransactionEventHeader extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.kafka.demo.avro.model.TransactionEventHeader.Builder newBuilder() {
    return new com.kafka.demo.avro.model.TransactionEventHeader.Builder();
  }
   ...
   * @return A new TransactionEventHeader RecordBuilder
   */
  public static com.kafka.demo.avro.model.TransactionEventHeader.Builder newBuilder(com.kafka.demo.avro.model.TransactionEventHeader.Builder other) {
    if (other == null) {
      return new com.kafka.demo.avro.model.TransactionEventHeader.Builder();
    } else {
      return new com.kafka.demo.avro.model.TransactionEventHeader.Builder(other);
    }
  }
   ...
   * @return A new TransactionEventHeader RecordBuilder
   */
  public static com.kafka.demo.avro.model.TransactionEventHeader.Builder newBuilder(com.kafka.demo.avro.model.TransactionEventHeader other) {
    if (other == null) {
      return new com.kafka.demo.avro.model.TransactionEventHeader.Builder();
    } else {
      return new com.kafka.demo.avro.model.TransactionEventHeader.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TransactionEventHeader>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kafka.demo.avro.model.TransactionEventHeader.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kafka.demo.avro.model.TransactionEventHeader other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.demo.avro.model.TransactionEventHeader.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.demo.avro.model.TransactionEventHeader.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.demo.avro.model.TransactionEventHeader.Builder setSourceSystem(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.demo.avro.model.TransactionEventHeader.Builder clearSourceSystem() {
      sourceSystem = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.demo.avro.model.TransactionEventHeader.Builder setCreatedAt(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.demo.avro.model.TransactionEventHeader.Builder clearCreatedAt() {
