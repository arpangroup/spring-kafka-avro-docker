...
- [Spring Boot Mapstruct | convert Order to OrderDTO along with totalPrice Calculation.](https://youtu.be/rG7lJWU2mi8?si=4bNbugICEXlWy4Ax)
- [Live Coding - Kafka Error Handling - Dynamically Start/Stop Kafka Consumer](https://youtu.be/X3GyxCpl9XQ?si=CrTETW-oDljVBMwj)
- [Live Coding - Docker Compose + Kafka + Spring Boot Application](https://youtu.be/dTWxl5XgGZc?si=4BUub9HwrHgcLRh-)
- [git init - local kafka setup with docker-compose - kafka retry-exception handler project](https://youtu.be/krGUFcmqfds?si=ZKTI5w9hdX6Jcy93)
- 
